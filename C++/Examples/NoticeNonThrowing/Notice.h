...
public:
  ...
  std::vector<cbe::Group> myGroups{cbe::DefaultCtor{}};
  ...
  const std::string subContainerName        = "IoT";
  ...
  std::string recent_by  = "car";
  std::string recent_msg = "traveling to Gothenburg";
